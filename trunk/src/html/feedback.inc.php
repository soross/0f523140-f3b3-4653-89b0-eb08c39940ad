...
function get_feedbacks($num, $page)
{
    ...
    connect_db();
    $view = "SELECT * from feedback, (SELECT nickname FROM userinfo) as ui WHERE ui.user_id = feedback.user_id OR feedback.user_id='NULL' ORDER BY post_datetime DESC$limit";
